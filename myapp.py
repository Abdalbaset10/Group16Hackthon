...
class StudentPage(Screen):
    ...
    def showsh(self):
        self.manager.screens[19].build()
        self.manager.current = 'views'
...
class ChangeSgrade(Screen):
    ...
    def change_grade(self):
        ...
        if find_user(self.ids.studentid.text) == 0 :
            ...
            db.child("users").child(self.ids.studentid.text).child("Grades").update({teachersubject:self.ids.newgrade.text})
            gradechanged()
...
class viewsch(Screen):
    def build(self):
        day1=db.child('Class').child('sunday').get()
        day2=db.child('Class').child('monday').get()
        day3=db.child('Class').child('tuesday').get()
        day4=db.child('Class').child('wednesday').get()
        day5=db.child('Class').child('thursday').get()
        self.manager.screens[19].ids.s1.text=day1.val()['8:00']
        self.manager.screens[19].ids.s2.text = day1.val()['8:45']
        self.manager.screens[19].ids.s3.text = day1.val()['9:30']
        self.manager.screens[19].ids.s4.text = day1.val()['10:15']
        self.manager.screens[19].ids.s5.text = day1.val()['11:30']
        self.manager.screens[19].ids.s6.text = day1.val()['12:15']
        self.manager.screens[19].ids.s7.text = day1.val()['13:00']
        self.manager.screens[19].ids.m1.text = day2.val()['8:00']
        self.manager.screens[19].ids.m2.text = day2.val()['8:45']
        self.manager.screens[19].ids.m3.text = day2.val()['9:30']
        self.manager.screens[19].ids.m4.text = day2.val()['10:15']
        self.manager.screens[19].ids.m5.text = day2.val()['11:30']
        self.manager.screens[19].ids.m6.text = day2.val()['12:15']
        self.manager.screens[19].ids.m7.text = day2.val()['13:00']
        self.manager.screens[19].ids.t1.text = day3.val()['8:00']
        self.manager.screens[19].ids.t2.text = day3.val()['8:45']
        self.manager.screens[19].ids.t3.text = day3.val()['9:30']
        self.manager.screens[19].ids.t4.text = day3.val()['10:15']
        self.manager.screens[19].ids.t5.text = day3.val()['11:30']
        self.manager.screens[19].ids.t6.text = day3.val()['12:15']
        self.manager.screens[19].ids.t7.text = day3.val()['13:00']
        self.manager.screens[19].ids.w1.text = day4.val()['8:00']
        self.manager.screens[19].ids.w2.text = day4.val()['8:45']
        self.manager.screens[19].ids.w3.text = day4.val()['9:30']
        self.manager.screens[19].ids.w4.text = day4.val()['10:15']
        self.manager.screens[19].ids.w5.text = day4.val()['11:30']
        self.manager.screens[19].ids.w6.text = day4.val()['12:15']
        self.manager.screens[19].ids.w7.text = day4.val()['13:00']
        self.manager.screens[19].ids.th1.text = day5.val()['8:00']
        self.manager.screens[19].ids.th2.text = day5.val()['8:45']
        self.manager.screens[19].ids.th3.text = day5.val()['9:30']
        self.manager.screens[19].ids.th4.text = day5.val()['10:15']
        self.manager.screens[19].ids.th5.text = day5.val()['11:30']
        self.manager.screens[19].ids.th6.text = day5.val()['12:15']
        self.manager.screens[19].ids.th7.text = day5.val()['13:00']
